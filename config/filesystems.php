...
return [
    ...
    */
    ...
    'disks' => [
        ...
        'jupiter_covers' => [
            'driver' => 's3',
            'key' => env('AWS_COVERS_ACCESS_KEY_ID'),
            'secret' => env('AWS_COVERS_SECRET_ACCESS_KEY'),
            'region' => env('AWS_COVERS_REGION', 'auto'),
        ...
        'jupiter_books' => [
            'driver' => 's3',
            'key' => env('AWS_BOOKS_ACCESS_KEY_ID'),
            'secret' => env('AWS_BOOKS_SECRET_ACCESS_KEY'),
            'region' => env('AWS_BOOKS_REGION', 'auto'),
